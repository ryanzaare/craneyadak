...
function cyh_render_settings_page() {
	...
	<div class="wrap">
		...
		<h2>افزودن محصول</h2>
		<p>
			محصول را مثل هر نوشته‌ی دیگری از <strong>محصولات کرین یدک ← افزودن محصول جدید</strong>
			بسازید. دکمه‌های سیدر و تولید خودکار حذف شده‌اند: محتوا دیگر داخل کد افزونه
			نیست و افزودن محصول تازه نیازی به نصب دوباره‌ی افزونه ندارد.
			<br><em>برند و دسته</em> را می‌توانید به‌صورت انبوه از
			<strong>ابزارها ← ورود محتوای برند و دسته</strong> وارد کنید.
		</p>
		<p>
			<a class="button" href="<?php echo esc_url( admin_url( 'edit.php?post_type=product&page=cyh-import' ) ); ?>">
				رفتن به صفحه‌ی ورود محصولات
			</a>
		</p>
	</div>
	<?php
