...
function cyh_render_settings_page() {
	...
	<div class="wrap">
		...
		<h2>افزودن محصول</h2>
		<p>
			محصولات از طریق <strong>محصولات ← ورود محصولات از فایل</strong> وارد می‌شوند.
			دکمه‌های سیدر و تولید خودکار حذف شده‌اند: محتوا دیگر داخل کد افزونه نیست و
			افزودن محصول جدید نیازی به نصب دوباره‌ی افزونه ندارد.
		</p>
		<p>
