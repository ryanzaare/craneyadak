		...
		[
			...
			'fields'                => [
				...
				/* ═══════════════════════════════════════════════════════════
				   فیلترهای فنی دسته
				   ═══════════════════════════════════════════════════════════
				   ⚠️ این‌ها تا امروز در `src/data/filters.ts` هاردکد بودند —
				   ۲۱ دسته از ۳۱ دسته، هرکدام با برچسب مشخصه و راهنما. یعنی
				   افزودن یک دسته‌ی تازه که فیلتر فنی بخواهد، **تغییر کد**
				   لازم داشت. دقیقاً همان الگویی که بازنویسی ۳.۰.۰ برای
				   حذفش انجام شد و این یک مورد از قلم افتاده بود.

				   ⚠️ فیلد ACF تازه‌ای برای *مشخصات* ساخته نمی‌شود: این‌ها
				   روی همان `technical_specs` موجود محصول کار می‌کنند. هر
				   ردیف فقط می‌گوید «کدام برچسب مشخصه قابل فیلتر است».
				   ═══════════════════════════════════════════════════════ */
				[
					'key'             => 'field_cyh_cat_facets',
					'label'           => 'فیلترهای فنی این دسته',
					'name'            => 'spec_facets',
					'type'            => 'repeater',
					'instructions'    => 'هر ردیف یک فیلتر در صفحه‌ی دسته می‌سازد. «برچسب مشخصه» باید <strong>مو‌به‌مو</strong> با آنچه در مشخصات فنی محصول وارد می‌کنید یکی باشد، وگرنه فیلتر خالی می‌ماند. خالی گذاشتن کل این بخش ایرادی ندارد — آن‌وقت فقط فیلترهای عمومی (برند و موجودی) نشان داده می‌شوند.',
					'layout'          => 'block',
					'button_label'    => 'افزودن فیلتر',
					'show_in_graphql' => 1,
					'sub_fields'      => [
						[
							'key'             => 'field_cyh_facet_label',
							'label'           => 'عنوان فیلتر',
							'name'            => 'label',
							'type'            => 'text',
							'required'        => 1,
							'instructions'    => 'آنچه خریدار می‌بیند. مثال: «قطر سیم‌بکسل».',
							'show_in_graphql' => 1,
						],
						[
							'key'             => 'field_cyh_facet_spec',
							'label'           => 'برچسب مشخصه در محصول',
							'name'            => 'spec_label',
							'type'            => 'text',
							'required'        => 1,
							'instructions'    => 'باید دقیقاً با برچسبی که در «مشخصات فنی» محصول نوشته‌اید یکی باشد — حتی یک فاصله‌ی اضافه هم فیلتر را خالی می‌کند.',
							'show_in_graphql' => 1,
						],
						[
							'key'             => 'field_cyh_facet_kind',
							'label'           => 'نوع فیلتر',
							'name'            => 'kind',
							'type'            => 'select',
							'choices'         => [
								'checkbox' => 'انتخابی (چند گزینه‌ای)',
								'range'    => 'بازه‌ی عددی (کمینه/بیشینه)',
							],
							'default_value'   => 'checkbox',
							'instructions'    => '«بازه» فقط برای مشخصه‌های عددی. اگر مقدارها متنی‌اند، «انتخابی» را بگذارید.',
							'show_in_graphql' => 1,
						],
						[
							'key'             => 'field_cyh_facet_unit',
							'label'           => 'واحد',
							'name'            => 'unit',
							'type'            => 'text',
							'instructions'    => 'اختیاری. مثال: mm، تن، ولت.',
							'show_in_graphql' => 1,
						],
						[
							'key'             => 'field_cyh_facet_hint',
							'label'           => 'راهنمای خریدار',
							'name'            => 'hint',
							'type'            => 'textarea',
							'rows'            => 2,
							'instructions'    => 'یک جمله که بگوید چرا این مشخصه مهم است. همین جمله‌ها صفحه را از یک فهرست ساده به یک راهنمای خرید تبدیل می‌کنند.',
							'show_in_graphql' => 1,
						],
					],
				],
